      ...
      const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            // Puedes realizar acciones adicionales después de enviar el formulario con éxito
          } else {
                    ...
                    <div className="flex items-stretch justify-center">
                        <div className="grid md:grid-cols-2">
                            ...
                            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                                ...
                                <form action="https://portfolio-backend-910jipnbt-edusebass.vercel.app/send-email" method="POST" id="contactForm" onSubmit={handleSubmit}>
                                    <div className="mb-6">
